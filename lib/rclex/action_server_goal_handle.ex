defmodule Rclex.ActionServer.GoalHandle do
  ...
  def init(args) do
    ...
    {:ok, %{action_server: action_server, goal_info: goal_info, goal_request: goal_request, cancel_request: cancel_request}}
  end
  ...
  def to_status(value) do
    Map.fetch!(@atom_to_state, value)
  end

  def from_status(value) do

...
static ErlNifFunc nif_funcs[] = {
    ...
    nif_regular_func(rcl_publisher_can_loan_messages, 1),
    nif_regular_func(rcl_publish_loaned_message, 2),
    nif_regular_func(rcl_borrow_loaned_message, 2),
    nif_regular_func(rcl_return_loaned_message_from_publisher, 2),
    nif_io_bound_func(rcl_subscription_init, 4),
    nif_io_bound_func(rcl_subscription_fini, 2),
    nif_io_bound_func(rcl_take, 2),
    nif_regular_func(rcl_subscription_can_loan_messages, 1),
    nif_regular_func(rcl_take_loaned_message, 1),
    nif_regular_func(rcl_return_loaned_message_from_subscription, 2),

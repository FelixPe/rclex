...
static ErlNifFunc nif_funcs[] = {
...
#endif
    nif_io_bound_func(rcl_action_client_init, 8),
    ...
    nif_io_bound_func(rcl_action_server_init, 10),
    ...
    nif_regular_func(rcl_action_goal_info_get_uuid, 1),
    nif_regular_func(rcl_action_goal_info_get_stamp, 1),
    nif_regular_func(rcl_action_goal_info_set_uuid, 2),
    nif_regular_func(rcl_action_goal_info_set_stamp, 2),
    nif_regular_func(rcl_action_get_zero_initialized_goal_info, 0),
    nif_regular_func(rcl_action_get_zero_initialized_goal_status_array, 0),
    nif_regular_func(rcl_action_get_zero_initialized_cancel_request, 0),
    nif_regular_func(rcl_action_get_zero_initialized_cancel_response, 0),

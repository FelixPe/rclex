...
static ErlNifFunc nif_funcs[] = {
    ...
    nif_io_bound_func(rcl_take_request_with_info, 2),
    nif_io_bound_func(rcl_send_response, 3),
    nif_io_bound_func(rcl_client_init, 4),
    nif_io_bound_func(rcl_client_fini, 2),
    nif_io_bound_func(rcl_send_request, 2),
    nif_io_bound_func(rcl_take_response_with_info, 2),

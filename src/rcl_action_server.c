...
ERL_NIF_TERM nif_rcl_action_process_cancel_request(ErlNifEnv *env, int argc,
  ...
  *cancel_response_p = rcl_action_get_zero_initialized_cancel_response();
  ...
  rc_fini = rcl_action_cancel_response_fini(cancel_response_p);
  enif_free(cancel_response_p);
  if (rc_fini != RCL_RET_OK) return raise_with_safe_message(env, __FILE__, __LINE__, rc_fini);
  if (rc != RCL_RET_OK) {
    return raise_with_safe_message(env, __FILE__, __LINE__, rc);
  }
...
ERL_NIF_TERM nif_rcl_action_publish_feedback(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
  ...
  void *ros_feedback_message;
  if (!get_ros_message_data(env, argv[1], &ros_feedback_message)) return enif_make_badarg(env);

  rcl_ret_t rc;
  rc = rcl_action_publish_feedback(action_server_p, ros_feedback_message);
  if (rc != RCL_RET_OK) {
    return raise_with_safe_message(env, __FILE__, __LINE__, rc);
  }
...
ERL_NIF_TERM nif_rcl_action_publish_status(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
  ...
  rcl_ret_t rc;
  rc = rcl_action_publish_status(action_server_p, ros_status_array);
  if (rc != RCL_RET_OK) {
    return raise_with_safe_message(env, __FILE__, __LINE__, rc);
  }
...
ERL_NIF_TERM nif_rcl_action_send_cancel_response(ErlNifEnv *env, int argc,
  ...
  void *ros_message;
  if (!get_ros_message_data(env, argv[2], &ros_message)) return enif_make_badarg(env);

  rc = rcl_action_send_cancel_response(action_server_p, response_header_p, ros_message);
  if (rc == RCL_RET_OK)
    return atom_ok;
...
ERL_NIF_TERM nif_rcl_action_send_goal_response(ErlNifEnv *env, int argc,
  ...
  rc = rcl_action_send_goal_response(action_server_p, response_header_p, ros_message);
  if (rc == RCL_RET_OK)
    return atom_ok;
  else if (rc == RCL_RET_INVALID_ARGUMENT)
    return enif_make_badarg(env);
...
ERL_NIF_TERM nif_rcl_action_send_result_response(ErlNifEnv *env, int argc,
  ...
  rc = rcl_action_send_result_response(action_server_p, response_header_p, ros_message);
  if (rc == RCL_RET_OK)
    return atom_ok;
  else if (rc == RCL_RET_INVALID_ARGUMENT)
    return enif_make_badarg(env);
...
ERL_NIF_TERM nif_rcl_action_take_cancel_request(ErlNifEnv *env, int argc,
  ...
  rc = rcl_action_take_cancel_request(action_server_p, &request_header, ros_request_message);
  if (rc == RCL_RET_OK) {
...
ERL_NIF_TERM nif_rcl_action_take_goal_request(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
  ...
  rc = rcl_action_take_goal_request(action_server_p, &request_header, ros_request_message);
  if (rc == RCL_RET_OK) {
    rmw_request_id_t *obj = enif_alloc_resource(rt_rmw_request_id_t, sizeof(rmw_request_id_t));
    *obj                  = request_header;
    ERL_NIF_TERM term     = enif_make_resource(env, obj);
...
ERL_NIF_TERM nif_rcl_action_take_result_request(ErlNifEnv *env, int argc,
  ...
  rc = rcl_action_take_result_request(action_server_p, &request_header, ros_request_message);
  if (rc == RCL_RET_OK) {
    rmw_request_id_t *obj = enif_alloc_resource(rt_rmw_request_id_t, sizeof(rmw_request_id_t));
    *obj                  = request_header;
    ERL_NIF_TERM term     = enif_make_resource(env, obj);
...
ERL_NIF_TERM nif_rcl_action_goal_handle_fini(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
  ...
  rcl_action_goal_handle_t **goal_handle_pp;
  if (!enif_get_resource(env, argv[0], rt_rcl_action_goal_handle_t, (void **)&goal_handle_pp))
    return enif_make_badarg(env);

  rcl_ret_t rc;
  rc = rcl_action_goal_handle_fini(*goal_handle_pp);
...
ERL_NIF_TERM nif_rcl_action_update_goal_state(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
  ...
  rcl_ret_t rc;
  rc = rcl_action_update_goal_state(*goal_handle_pp, goal_event);
  if (rc != RCL_RET_OK) return raise_with_safe_message(env, __FILE__, __LINE__, rc);
...
ERL_NIF_TERM nif_rcl_action_goal_handle_get_info(ErlNifEnv *env, int argc,
  ...
  rcl_ret_t rc;
  rc = rcl_action_goal_handle_get_info(*goal_handle_pp, *goal_info_message_pp);
  if (rc != RCL_RET_OK) return raise_with_safe_message(env, __FILE__, __LINE__, rc);
...
ERL_NIF_TERM nif_rcl_action_goal_handle_get_status(ErlNifEnv *env, int argc,
  ...
  rcl_ret_t rc;
  rc = rcl_action_goal_handle_get_status(*goal_handle_pp, &status);
  if (rc != RCL_RET_OK) return raise_with_safe_message(env, __FILE__, __LINE__, rc);
...
ERL_NIF_TERM nif_rcl_action_goal_handle_is_active(ErlNifEnv *env, int argc,
  ...
  bool active = rcl_action_goal_handle_is_active(*goal_handle_pp);
...
ERL_NIF_TERM nif_rcl_action_goal_handle_is_cancelable(ErlNifEnv *env, int argc,
  ...
  bool active = rcl_action_goal_handle_is_cancelable(*goal_handle_pp);
...
ERL_NIF_TERM nif_rcl_action_goal_handle_is_valid(ErlNifEnv *env, int argc,
  ...
  bool active = rcl_action_goal_handle_is_valid(*goal_handle_pp);

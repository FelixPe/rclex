defmodule Rclex.Pkgs.Turtlesim.Action.RotateAbsolute.SendGoal.Response do
  @moduledoc false
  ...
  def type_support!() do
    Nif.turtlesim_action_rotate_absolute__send_goal__response_type_support!()
  end

  def create!() do
    Nif.turtlesim_action_rotate_absolute__send_goal__response_create!()
  end

  def destroy!(message) do
    Nif.turtlesim_action_rotate_absolute__send_goal__response_destroy!(message)
  end

  def set!(message, %__MODULE__{} = struct) do
    Nif.turtlesim_action_rotate_absolute__send_goal__response_set!(message, to_tuple(struct))
  end

  def get!(message) do
    Nif.turtlesim_action_rotate_absolute__send_goal__response_get!(message) |> to_struct()
  end

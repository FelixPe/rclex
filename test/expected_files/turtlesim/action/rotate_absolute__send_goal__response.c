// clang-format off
#include "rotate_absolute__send_goal__response.h"
#include "../../../macros.h"
...
ERL_NIF_TERM nif_turtlesim_action_rotate_absolute__send_goal__response_type_support(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
  ignore_unused(argv);

  if (argc != 0) return enif_make_badarg(env);

  const rosidl_message_type_support_t *ts_p = ROSIDL_GET_MSG_TYPE_SUPPORT(turtlesim, action, RotateAbsolute_SendGoal_Response);
...
ERL_NIF_TERM nif_turtlesim_action_rotate_absolute__send_goal__response_create(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
  ignore_unused(argv);

  if (argc != 0) return enif_make_badarg(env);

  turtlesim__action__RotateAbsolute_SendGoal_Response *message_p = turtlesim__action__RotateAbsolute_SendGoal_Response__create();
...
ERL_NIF_TERM nif_turtlesim_action_rotate_absolute__send_goal__response_destroy(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
  ...
  turtlesim__action__RotateAbsolute_SendGoal_Response *message_p = (turtlesim__action__RotateAbsolute_SendGoal_Response *)*ros_message_pp;
  turtlesim__action__RotateAbsolute_SendGoal_Response__destroy(message_p);

  return atom_ok;
}

ERL_NIF_TERM nif_turtlesim_action_rotate_absolute__send_goal__response_set(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
...
ERL_NIF_TERM nif_turtlesim_action_rotate_absolute__send_goal__response_get(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]) {
  if (argc != 1) return enif_make_badarg(env);
